...
\begin{category}[D]{\textsc{Articles Published in the Federal Reserve Bank of Cleveland \textit{Forefront}}}
  \input{FF.bibtxt}
\end{category}

\begin{category}[E]{\textsc{Articles Published in the Federal Reserve Bank of St. Louis \textit{Review}}}
  \input{Review.bibtxt}
\end{category}

\begin{category}[F]{\textsc{Articles Published in the Federal Reserve Bank of St. Louis \textit{The Regional Economist}}}
  \input{RegEco.bibtxt}
\end{category}

\begin{category}[G]{\textsc{Articles Published in the Federal Reserve Bank of St. Louis \textit{National Trends/Economic Synopses}}}
  \input{ES.bibtxt}
\end{category}

\begin{category}[H]{\textsc{Alternative versions}}
